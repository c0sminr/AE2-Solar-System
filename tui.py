def welcome():
    ...
    #   number of dashes based on the lenght of the message
    nDash = len(message) * '-'

    #   print welcome message
    print(nDash, message, nDash)
...
def menu():
    ...
    # menu options
    menuOptions = {1: 'Load Data', 2: 'Process Data', 3: 'Visualise Data', 4: 'Save Data', 5: 'Exit'}

    # iterating
    for i, v in menuOptions.items():
        print('{}\t{}'.format(i, v))
...
def source_data_path():
    ...
    filePath = input("Please enter the file path for a data file (e.g. 'data/sol_data.csv')")
    if filePath.endswith(".csv"):
        return filePath
    else:
        print("The file path entered does not end in", ".csv")
...
def process_type():
    ...
    # menu options
    menuOptions = {1: 'Retrieve entity', 2: 'Retrieve entity details', 3: 'Categorise entities by type',
                   4: 'Categorise entities by gravity', 5: 'Summarise entities by orbit', 6: 'Main Menu'}
...
def entity_name():
    ...
    The function should ask the user to enter the name of an entity e.g. 'Earth's
    ...
    while True:
        try:
            entity_Name: str = input("Please enter the name of an entity:")
        except ValueError:
            print("Please retype:")
        else:
            break
...
def entity_details():
    ...
    # while 1:
    #     i += 1
    #     input_index = input('To Stop, press enter key. Enter item %d: ' % i)
    #     if input_index == '':
    #         break
    ...
    list_index = []
    list_planets = []
    list_planets = [planet_name for planet_name in input("Enter the list items : ").split()]
    list_index = [int(index_number) for index_number in
                  input("Enter a list of integer column indexes (eg: 1 2 3 4 etc) : ").split()]

    list_planets.append(list_index)
    return list_planets,list_index
